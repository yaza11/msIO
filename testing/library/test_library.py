...
def show_compound_properties():
    ...
    try:
        ...
        result_text.insert(tk.END, f"Metaboscape formula: {library.formula_metaboscape.get(feature_id)}\n")
        result_text.insert(tk.END, f"SIRIUS formula: {library.formula_sirius.get(feature_id)}\n")
